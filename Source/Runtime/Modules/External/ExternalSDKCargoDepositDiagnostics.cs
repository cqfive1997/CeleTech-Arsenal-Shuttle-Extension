...
{
    internal sealed class ExternalSDKCargoDepositDiagnostics
    {
        ...
        internal void LogInternalFailure(
            ...
            string message)
        {
            Log.Error("[CeleTech Shuttle] External SDK cargo deposit internal failure. kind=" +
                kind +
                " owner=" +
        ...
        private string SourceOwner(ExternalSDKCargoValidatedDepositRequest request)
        {
            return request != null &&
                request.Source != null &&
        ...
        private string SourceRequester(ExternalSDKCargoValidatedDepositRequest request)
        {
            return request != null &&
                request.Source != null &&
