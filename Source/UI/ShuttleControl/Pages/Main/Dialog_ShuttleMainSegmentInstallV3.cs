...
{
    internal sealed class Dialog_ShuttleMainSegmentInstallV3 : Window
    {
        ...
        internal Dialog_ShuttleMainSegmentInstallV3(
            ...
            : this(candidateProvider, getResearchFingerprint, onInstall, false)
        {
        }
        ...
        {
            get { return new Vector2(780f, 600f); }
        }
        ...
        private void DrawHeader(Rect rect)
        {
            ...
            ShuttleUILayout.SafeLabel(
                ...
                this.text.Tr(this.replacing
                    ? "CT_Shuttle_UI_SegmentReplace_SelectSegmentTitle"
                    : "CT_Shuttle_UI_SegmentInstall_SelectSegmentTitle"));
            ...
            ShuttleUILayout.SafeLabel(
                ...
                this.text.Tr(this.replacing
                    ? "CT_Shuttle_UI_SegmentReplace_HeaderHint"
                    : "CT_Shuttle_UI_SegmentInstall_HeaderHint"));
        ...
        private void DrawEmptyState(Rect rect)
        {
            ...
            ShuttleUILayout.SafeLabel(
                ...
                this.text.Tr("CT_Shuttle_UI_SegmentInstall_Empty"));
            Text.Font = GameFont.Small;
            GUI.color = Color.white;
        }
            ...
            V3MainInstallCandidateModel candidate)
        {
            ...
            this.panel.DrawFramelessIcon(
                glyphRect,
                this.icons.GetIcon(this.iconKeys.GetCandidateIconKey(candidate, true)),
            ...
            this.panel.DrawButton(
                buttonRect,
                this.text.Tr(this.replacing
                    ? "CT_Shuttle_UI_SegmentReplace_Replace"
                    : "CT_Shuttle_UI_SegmentInstall_Install"),
        ...
        private void DrawFooter(Rect rect)
        {
            ...
            this.panel.DrawButton(
                closeRect,
                this.text.Tr("CT_Shuttle_UI_SegmentInstall_Close"),
                null,
                delegate { this.Close(); });
        }
        ...
        private List<V3MainInstallCandidateModel> BuildCandidatesFromProvider()
        {
            ...
            {
                Log.Warning("[CeleTech Shuttle] V3 segment install candidate refresh failed: " + exception.Message);
                return new List<V3MainInstallCandidateModel>();
            }
        }
        ...
        private int ReadResearchFingerprint()
        {
            ...
            {
                Log.Warning("[CeleTech Shuttle] V3 segment install fingerprint read failed: " + exception.Message);
        ...
        private string GetFallbackGlyph(V3MainInstallCandidateModel candidate)
        {
            ...
            return string.IsNullOrEmpty(label) ? "S" : label.Substring(0, 1).ToUpperInvariant();
        }
    }
}
