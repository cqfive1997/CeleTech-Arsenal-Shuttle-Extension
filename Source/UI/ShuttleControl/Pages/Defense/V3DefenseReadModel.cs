...
{
    internal sealed class V3DefensePageReadModel
    {
        internal int OnlineWeaponCount;
        internal int OnlineFireControlCount;
        internal bool AutoLoaderInstalled;
        internal float WeaponPowerWatts;
        internal string WeaponBayStatusText;
        internal string WeaponBayStatusKey;
        internal V3DefenseShieldPanelModel Shield = new V3DefenseShieldPanelModel();
        internal ShuttleHullReadModel Hull = new ShuttleHullReadModel();
        internal readonly List<V3DefenseMetricModel> Metrics =
            new List<V3DefenseMetricModel>();
        internal readonly List<V3DefenseWeaponEntryModel> Weapons =
            new List<V3DefenseWeaponEntryModel>();
        internal V3DefenseWeaponEntryModel SelectedWeapon;
    }

    internal sealed class V3DefenseMetricModel
    {
    ...
    internal sealed class V3DefenseWeaponEntryModel
    {
        internal string Id;
        ...
        internal bool AutoLoaderAvailable;
        ...
        internal readonly List<V3DefenseAmmoOptionModel> AmmoOptions =
            new List<V3DefenseAmmoOptionModel>();
        internal string StatusLabel;
        internal string StatusKey;
        internal Vector2 UIAnchor;
        internal string Tooltip;
        internal ShuttleControlSegmentSlotModel SegmentSlot;
        internal ShuttleControlModuleSlotModel ModuleSlot;
    }

    internal sealed class V3DefenseAmmoOptionModel
    {
    ...
    internal sealed class V3DefenseShieldPanelModel
    {
